...
namespace UT1_BugSquash
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            } while (!int.TryParse(sNumber, out nX)); // sNumber did not have a value

            do
            {
                Console.Write("Enter a positive whole number for y: ");
                sNumber = Console.ReadLine();
            } while (int.TryParse(sNumber, out nY)); // was nX, should be nY so both have values
        ...
        int Power(int nBase, int nExponent)
        {
            ...
            return returnVal; // missing "return"
        }
    }
}
